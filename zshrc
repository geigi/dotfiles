...
plugins=(git osx ruby python brew brew-cask colorize golang history history-substring-search autojump common-aliases)
...
alias ls='gls -GFh -a --color'
alias ll='gls -lGa -a --color'
